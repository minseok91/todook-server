...
@ApiResponses(value ={
        ...
        @ApiResponse(responseCode = "403", description = "FORBIDDEN", content = @Content(schema = @Schema(implementation = com.todook.crocodile.presentation.ApiResponse.class), examples = {
